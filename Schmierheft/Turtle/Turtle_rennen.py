...
Horst = Turtle() #inheriting the last turtle
Horst.color('maroon') #setting the color of the turtle as "blue"
Horst.shape('turtle') #declaring the shape of the turtle
Horst.penup() #not ready to draw
Horst.goto(-160,40) #positioning
Horst.pendown() #ready
