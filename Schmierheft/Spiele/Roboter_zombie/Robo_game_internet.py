...
class zombie:
    def __init__(self,x,y,geschw,breite,hoehe,richtg,xMin,xMax):
        ...
        self.xMax = xMax
        self.leben = 6
        self.linksListe = [pg.image.load("Grafiken/l1.png"),pg.image.load("Grafiken/l2.png"),pg.image.load("Grafiken/l3.png"),pg.image.load("Grafiken/l4.png"),pg.image.load("Grafiken/l5.png"),pg.image.load("Grafiken/l6.png"),pg.image.load("Grafiken/l7.png"),pg.image.load("Grafiken/l8.png")]
        self.rechtsListe = [pg.image.load("Grafiken/r1.png"),pg.image.load("Grafiken/r2.png"),pg.image.load("Grafiken/r3.png"),pg.image.load("Grafiken/r4.png"),pg.image.load("Grafiken/r5.png"),pg.image.load("Grafiken/r6.png"),pg.image.load("Grafiken/r7.png"),pg.image.load("Grafiken/r8.png")]
        self.ganz = pg.image.load("Grafiken/voll.png")
        self.halb = pg.image.load("Grafiken/halb.png")
        self.leer = pg.image.load("Grafiken/leer.png")
    def herzen(self):
        if self.leben >= 2:
